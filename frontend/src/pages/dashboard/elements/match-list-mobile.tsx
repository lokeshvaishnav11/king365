        ...
        <table className="table coupon-table coupon-table-mobile">
          ...
          <tbody>
            {isHomePage && !isInPlayPage ? (
              ...
              <>
                 <tr className="border-bottom min-h-10">
                          <td colSpan={4}>
                            <div className="game-name pb-2">
                              <a
                                // onClick={() => props.currentMatch(match)}
                                className="text-edark"
                                href={undefined}
                              ...
                              >
                                {"Ball By Ball"}<span className="vimaan-text px-1" style={{fontSize:"10px"}}>In Play</span> 
                      ...
                      <i className='fas fa-tv v-m icon-tv' />
                              ...
                              { (
                                <span className="game-fancy me-1">S</span>
                              )}
