...
<div className="fw-bold">Main PTI {Math.max(0, (balance?.balance || 0) - ((balance?.exposer || 0) + (balance?.casinoexposer || 0)))}
        ...
        <div className="container-fluid d-none" style={{ padding: "0" }}>
                  ...
                  <div className="w-100 px-2">
                    ...
                    >
                      <CustomLink
                        ...
                        style={{
                          background:
                            "linear-gradient(180deg, #007b15, #138e00)",
                          color: "#fff",
                      ...
                      <CustomLink
                        ...
                        style={{
                          background:
                            "linear-gradient(180deg, #7b0000, #d10000)",
                          color: "#fff",
                          border: "1px solid #fff",
                          borderRadius: "4px",
                          fontSize: "14px",
              ...
              <button
                ...
                onClick={() => {
                  if (userParentAlldata?.parent?.phone) {
                    const phoneNumber =
                      userParentAlldata?.parent?.phone?.replace(/[^0-9]/g, "");
      ...
      <div className="top-bar d-none justify-content-between align-items-center px-3">
        {/* LEFT LOGO */}
        <div className="log">
        ...
        {/* RIGHT SECTION */}
        <div
          className="right-section d-flex align-items-center gap-20"
          style={{ gap: "5px" }}
        >
          {/* SEARCH ICON */}
