...
const PlaceBetBoxMatchOdds = ({ stake }: { stake: IUserBetStake }) => {
  console.log(stake, "stakwwwe");
...
export default React.memo(PlaceBetBoxMatchOdds);
