...
//   console.log("liveMatchData", liveMatchData,lastOdds);
...
//       liveMatchData?.data.defaultMarkets?.filter(
...
//   return (
//     <div>
//       <div className="d-t-box m-b-10 buttonsuspended d-none">
...
//         </div>
//       </div> : ""} */}
//       <div className="d-flex justify-content-between m-b-10 p-2 bg-theme text-white rounded"><span>WINNER</span> <i className="fa fa-info-circle" aria-hidden="true"></i> </div>
//       <div className="row row5 d-flex">
//         {isMobile ? (
//           <div className="col-lg-6 col-6">
//             {" "}
//             <h4
//               className="m-b-0 text-center text-uppercase"
//               style={{ fontSize: "12px", fontWeight: "700" }}
//             >
//               Dragon
//             </h4>
//             <div
//               className="d-t-box m-b-10 buttonsuspended"
//               style={{ background: "#72bbef", borderRadius: "10px" }}
//             >
//               <div className="row row6">
//                 <div className="col-12 text-center">
...
//       {/* <div className='row row5 w-50 '> */}
//       {isMobile ? (
//         <div className="col-lg-6 col-12 align-items-center d-flex flex-column ">
//           {" "}
//           <h4
//             className="m-b-0 text-center text-uppercase"
//             style={{ fontSize: "12px", fontWeight: "700" }}
...
//           </h4>
//           <div
//             className="d-t-box m-b-10 buttonsuspended w-50"
//             style={{ background: "#72bbef", borderRadius: "10px" }}
//           >
//             <div className="row ">
//               <div className="col-12 text-center">
...
//         ""
//       )}
//       {/* {isMobile  ? <div className='col-lg-6 col-12'>
